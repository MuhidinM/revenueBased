          ...
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                E-Gate is one of the most convenient ways to accept online
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                E-gate is a fast transaction system that allows you to trade in
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                It's easy to integrate into your online storefront and gives you
                access to several banking institutions, so you can increase
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                We have strict policies and procedures in place to ensure that
                our business practices are legally compliant.
              </p>
            </div>
            <div>
              <div className="flex items-center justify-center w-10 h-10 mb-4 rounded-full bg-primary lg:h-12 lg:w-12 dark:bg-primary">
